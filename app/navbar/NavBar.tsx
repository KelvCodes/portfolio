...
const NavBar = () => {
  ...
  return (
    <nav className="fixed bottom-10 left-0 right-0 z-50 my-0  mx-auto  flex w-[306px] items-center justify-center gap-1 rounded-lg bg-[#07070a]/90 px-1 py-1 text-[#e4ded7] backdrop-blur-md sm:w-[383.3px] md:p-2 lg:w-[391.3px]">
      <Link
        href="https://www.linkedin.com/safety/go?url=https%3A%2F%2Fdrive.google.com%2Ffile%2Fd%2F1gwgVoefVBTsVjiL8czYwQCdNo9laarjI%2Fview%3Fusp%3Ddrivesdk&trk=flagship-messaging-web&messageThreadUrn=urn%3Ali%3AmessagingThread%3A2-YzA3NWYxNWQtMzVkZC00ZDA2LWFmOGQtNGY4NWY0YjMxZjE1XzEwMA%3D%3D&lipi=urn%3Ali%3Apage%3Ad_flagship3_messaging_conversation_detail%3Bxymhv5VpQFapbK7G7yU%2FUg%3D%3D"
        target="_blank"
        className="flex"
