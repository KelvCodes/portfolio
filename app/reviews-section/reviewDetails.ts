...
export const reviewDetails: reviewProps[] = [
  ...
  },
  {
    ...
    profileImg: emma,
    testimonial:
      "Kelvin was an exceptional student in my Blckain course. His smart contract project using Solidity showcased deep understanding and creativity, earning top marks.",
    index: 1,
  },
  {
