...
export const reviewDetails: reviewProps[] = [
  ...
  },
  {
    ...
    profileImg: emma,
    testimonial:
      "Kelvin was an exceptional student in my Mathematics course and some Blockchain lessons. His smart contract project using Solidity showcased deep understanding and creativity, earning top marks.",
    index: 1,
  },
  {
