...
import { FaGithub, FaInstagram, FaLinkedin, FaYoutube } from "react-icons/fa"; // Import icons
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          ...
          >
            <motion.div
              variants={bodyAnimation}
              className="text-[24px] text-[#e4ded7] hover:text-[#ffffff] transition-colors"
            >
              <FaGithub />
            </motion.div>
          </Link>
          ...
          <Link
            href="https://instagram.com/_.yo.kelvin"
            target="_blank"
            aria-label="View Twitter Profile"
          >
            <motion.div
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            ...
            <Link
              href="https://www.bytebao.io/"
              target="_blank"
              className="underline underline-offset-2 hover:no-underline"
              aria-label="ByteBao Website"
            >
              ByteBao,
            </Link>{" "}
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on interfaces and experiences, working remotely from Tema,
            Ghana.
          </p>
        </motion.div>
      </div>
